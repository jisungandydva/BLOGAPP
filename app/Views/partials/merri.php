        ...
        <div class="row g-4 align-items-start">
            ...
            <div class="col-lg-8">
                ...
                <p class="bio-desc mt-3">
                    Sebagai seorang Content Writer sekaligus Story Creator, saya berfokus pada pembuatan konten yang informatif, 
                    menarik, dan memiliki nilai yang jelas bagi audiens. Saya terbiasa menulis berbagai jenis konten, mulai dari artikel, 
                    copywriting, caption, hingga storytelling yang mampu membangun hubungan emosional dengan pembaca. Dalam setiap 
                    tulisan, saya selalu memperhatikan struktur, kejelasan pesan, tone of voice, serta tujuan yang ingin dicapai.
                    Saya memiliki kemampuan dalam melakukan riset, mengembangkan ide, dan menyampaikan informasi secara efektif melalui 
                    bahasa yang relevan dengan target pembaca. Selain itu, saya selalu mengikuti perkembangan tren media digital, 
                    gaya penulisan, dan strategi konten agar hasil yang saya buat tetap segar, relevan, dan profesional.
                    Tujuan saya adalah menciptakan konten yang tidak hanya enak dibaca, tetapi juga mampu meningkatkan engagement, 
                    memperkuat branding, dan membantu mencapai tujuan komunikasi yang diinginkan.
                </p>
